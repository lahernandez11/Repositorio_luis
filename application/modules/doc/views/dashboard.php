...
<div class="page-header">
    ...
    <i class="fa fa-institution fa-2x"></i> DOCUMENTOS </a>/ <a class="bom-menu" href="<?=base_url('doc/contratos_concesion/index')?>">CONTRATOS DE CONCESI&Oacute;N </a> / DASHBOARD</h4>
</div>
<?php
$fecha =date('Y-m-d');
$fecha2meses = date('Y-m-d',strtotime('+2 months', strtotime($fecha)));
?>
<div class="row">  
  <div class="col-md-2 col-md-offset-7">     
  	<label for="Inicio" class=" control-label">Inicio</label>
    	<div class="input-append input-group datepicker date1">            	
        	<input data-format="yyyy-MM-dd" value="<?=date('Y-m-d')?>" type="text" class="form-control letra11 calendario" readonly name="fecha_inicio" id="fecha_inicio">
