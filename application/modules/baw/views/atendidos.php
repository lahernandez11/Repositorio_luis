<div class="page-header">
	...
	<h5><b>
    <img src="<?=base_url('assets/img/1399336774_View_Details.png')?>"> <a class="bom-menu" href="<?=base_url('baw/home/index')?>">BIT&Aacute;CORA DE ATENCI&Oacute;N WEB / </a> <a class="bom-menu" href="<?=base_url('baw/administrar/index')?>">ADMINISTRAR / </a><a class="bom-menu" href="<?=base_url('baw/administrar/atendidos')?>">SOLICITUDES ATENDIDAS</a></b></h5>
</div>
<div class="row">
