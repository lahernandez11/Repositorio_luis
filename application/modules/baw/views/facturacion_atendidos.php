<div class="page-header">
	<div class="btn-group pull-right" style="margin-left:5px;">
        ...
        <ul class="dropdown-menu ayuda">
            <li><a href="<?=base_url('downloads/baw/v20140512_opi-consultar-solicitudes.pdf')?>" download><i class="fa fa-file"></i> Consultar Solicitud</a></li>
        </ul>
    </div>
	<h5><b>
    <img src="<?=base_url('assets/img/1399336774_View_Details.png')?>"> <a class="bom-menu" href="<?=base_url('baw/home/index')?>">BIT&Aacute;CORA DE ATENCI&Oacute;N WEB / </a> <a class="bom-menu" href="<?=base_url('baw/facturacion/index')?>">SOLICITUD DE FACTURACI&Oacute;N / </a><a class="bom-menu" href="<?=base_url('baw/facturacion/atendidos')?>">SOLICITUDES ATENDIDAS</a></b></h5>
</div>
<div class="row">
        ...
        $(function () {
            $("#grid").igGrid({
                ...
                columns: [
					...
					{ headerText: "ACCION", key: "idcon_solicitud", dataType: "string", width: "10%",
					  template: "<a href='<?=base_url('baw/facturacion/consulta')?>/${idcon_solicitud}' class='atendidos' id='${idcon_solicitud}'>CONSULTAR</a>"}
                ],
