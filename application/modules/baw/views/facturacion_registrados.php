<div class="page-header">
	...
	<h5><b>
    <img src="<?=base_url('assets/img/1399334070_user.png')?>"> <a class="bom-menu" href="<?=base_url('baw/home/index')?>">BIT&Aacute;CORA DE ATENCI&Oacute;N WEB / </a><a class="bom-menu" href="<?=base_url('baw/facturacion/index')?>">SOLICITUD DE FACTURACI&Oacute;N / </a><a class="bom-menu" href="<?=base_url('baw/facturacion/registrados')?>">SOLICITUDES REGISTRADAS</a></b></h5>
</div>
<div class="row">
    ...
    <div id="menu">
        ...
        <a href="<?=base_url('baw/facturacion/validacion_automatica')?>" class="btn btn-success pull-right">Validaci&oacute;n autom&aacute;tica</a>
        <br/><br/>
            ...
            $("#grid").igGrid({
                ...
                columns: [
					...
					{ headerText: "ACCION", key: "idsolicitud", dataType: "string", width: "10%",
					  template: "<a href='<?=base_url('baw/facturacion/solicitudes_atendidas')?>/${idsolicitud}/1' class='' id='${idsolicitud}'>VALIDAR</a>&nbsp;&nbsp;&nbsp;<a href='<?=base_url('baw/facturacion/solicitudes_descartadas')?>/${idsolicitud}' id='${idsolicitud}' class='descartados'>DESCARTAR</a>"}
                ],
