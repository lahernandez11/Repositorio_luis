...
<div class="page-header">
	<h5><b>
    <img src="<?=base_url('assets/img/1399334070_user.png')?>"> <a class="bom-menu" href="<?=base_url('baw/home/index')?>">BIT&Aacute;CORA DE ATENCI&Oacute;N WEB / </a><a class="bom-menu" href="<?=base_url('baw/facturacion/index')?>">SOLICITUD DE FACTURACI&Oacute;N / </a>
    <?php if($accion==1):?>
    	<a class="bom-menu" href="<?=base_url('baw/facturacion/registrados')?>">SOLICITUDES REGISTRADAS</a>
	<?php else:?>
    	<a class="bom-menu" href="<?=base_url('baw/facturacion/atendiendose')?>">SOLICITUDES ATENDIENDOSE</a>
    <?php endif;?>
    </b></h5>
</div>
<?=form_open_multipart('baw/facturacion/enviar_datos',array('class'=>'form-horizontal','role'=>'form','id'=>'solicitar_info'));?>
<div class="row">
	<div class="col-md-6">
    ...
    <div class="col-md-6" id="solicitar">
    	<div class="square letra10"> 
            ...
            <div class="row" align="center">
                <div class="col-md-12">
                    <a href="<?=base_url('baw/facturacion/solicitudes_atendidas')?>/<?=$solicitudes[0]["idcon_solicitud"]?>/0" class="btn btn-warning cancelar-state">Cancelar</a>
                    <button type="submit" id="fact_btn_enviar" class="btn btn-success loading-state">Enviar</button>
                </div>
            </div>
        </div>
    </div>
