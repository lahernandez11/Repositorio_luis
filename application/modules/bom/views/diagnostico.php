<div class="page-header">
	<h4>
    <img src="<?=base_url('assets/img/1383194873_services.png')?>"><a class="bom-menu" href="<?=base_url('bom/home/index')?>"> BIT&Aacute;CORA DE OPERACI&Oacute;N Y MANTTO. / </a>REGISTRO DE DIAGN&Oacute;STICOS
    <div class="btn-group pull-right" style="margin-left:5px;">
  		...
  		<ul class="dropdown-menu ayuda">
    		<li><a href="<?=base_url('downloads/bom/v20140408_opi-registrar-diagnostico.pdf')?>" download><i class="fa fa-file"></i> Registrar Diagn&oacute;stico</a></li>
  		</ul>
	</div>
    </h4>
</div>
...
<table id="example" class="table table-bordered table-striped table-condensed">
    	...
    	<tbody>
        	<?php $n=0; foreach($reportes as $reporte): $n++;?>
            	<tr align="center">
                	<td align="left"><?=$n?></td>
                	<td><a class="info_d" id="<?=$reporte->idreporte?>" href="#Modal<?=$reporte->idreporte?>" data-toggle="modal"><?=$reporte->folio?></a>
                    ...
                    <td><a href="<?=base_url('bom/diagnostico/generales/'.$reporte->idreporte)?>">REGISTRAR</a></td>
                </tr>
    		<?php endforeach;?>
        </tbody>
    </table>
