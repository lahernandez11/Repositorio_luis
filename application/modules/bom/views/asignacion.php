<div class="page-header">
	<h4>
    <img src="<?=base_url('assets/img/1383194266_online_support.png')?>"> <a class="bom-menu" href="<?=base_url('bom/home/index')?>"> BIT&Aacute;CORA DE OPERACI&Oacute;N Y MANTTO. / </a>ASIGNACI&Oacute;N DE T&Eacute;CNICO A REPORTE
    <div class="btn-group pull-right" style="margin-left:5px;">
  		...
  		<ul class="dropdown-menu ayuda">
    		<li><a href="<?=base_url('downloads/bom/v20140227_opi-asignar-tecnico.pdf')?>" download><i class="fa fa-file"></i> Asignar t&eacute;cnico</a></li>
  		</ul>
	</div>
    </h4>
</div>
...
<table id="example" class="table table-bordered table-striped table-condensed">
    	...
    	<tbody>
        	<?php $n=0; foreach($reportes as $reporte): $n++;?>
            	<tr align="center">
                	<td align="left"><?=$n?></td>
                	<td><a class="info_t" id="<?=$reporte->idreporte?>" href="#Modal<?=$reporte->idreporte?>" data-toggle="modal"><?=$reporte->folio?></a>
                    ...
                    <td><a href="<?=base_url('bom/asignacion/generales/'.$reporte->idreporte)?>">ASIGNAR</a></td>
                </tr>
    		<?php endforeach;?>
        </tbody>
    </table>
