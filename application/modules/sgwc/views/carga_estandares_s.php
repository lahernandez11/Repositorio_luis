<div class="row letra10">
    ...
    <div class="col-md-2 form-group verticalLine-2">
    ...
    <div class="col-md-3 form-group verticalLine">
    	<label style="text-align:left" for="clase" class="col-sm-12 control-label">Tramo: </label>
        <div class="col-sm-11">            
            <div><input type="checkbox" id="s_todo"> <span id="i_todo">MARCAR TODO</span></div>
            	<?php foreach($segmentos as $segmento):?>
                	<div><input type="checkbox" name="segmento[]" class="segmento checkAll_s" value="<?=$segmento->tramoID?>"> <?=$segmento->tramo?></div>
                <?php endforeach ?>                
        </div>
    </div>
    <div class="col-md-5 form-group verticalLine">
