<div class="page-header">
	<h5><b>
    <img src="<?=base_url('assets/img/1409271617_519616-115_List-32.png')?>"> <a class="bom-menu" href="<?=base_url('sgwc/reporte/index')?>">SGWC</a> / <a class="bom-menu" href="<?=base_url('sgwc/reporte/reporte_foto')?>">REPORTE FOTOGR&Aacute;FICO</a> / <a class="bom-menu" href="<?=base_url('sgwc/reporte/configuracion')?>">CONFIGURACI&Oacute;N / ORDEN-DESCRIPCI&Oacute;N</a></b></h5>
</div>
