<div class="page-header">
	<h5><b>
    <img src="<?=base_url('assets/img/268131_settings2-512.png')?>"><a class="bom-menu" href="<?=base_url('sgwc/reporte/index')?>"> SGWC </a>/ <a class="bom-menu" href="<?=base_url('sgwc/eventos/reporte_eventos')?>">REPORTE FOTOGR&Aacute;FICO DE EVENTOS / GENERAR REPORTE </a></b></h5>
</div>
<?=form_open('',array('class'=>'form-horizontal','role'=>'form','id'=>'reporte'));?>
<fieldset>
	<h5><strong>DATOS DEL REPORTE DE EVENTOS</strong></h5>
    <br>
